...
#define WIRETRANS false //Use wire to transmit data
//ANALOG INPUT CONFIG
...
#define NO_THUMB true //If for some reason you don't want to track the thumb
...
#define SERVO_SCALING false //dynamic scaling of servo motors
  ...
  #define PIN_PINKY     35//36
  #define PIN_RING      35//39
  #define PIN_MIDDLE    35//34
  #define PIN_INDEX     35
  #define PIN_THUMB     32
  #define PIN_JOY_X     33
  #define PIN_JOY_Y     25
  ...
  #define PIN_CALIB     0 //button for recalibration (You can set this to GPIO0 to use the BOOT button, but only when using Bluetooth.//12)
  #define DEBUG_LED 2
